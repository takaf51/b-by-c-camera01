...
describe('Auth Domain Validation', () => {
  describe('validateEmail', () => {
    ...
    describe('無効なメールアドレス', () => {
      const invalidEmails = [
        ...
        { email: 'invalid', expectedError: '正しいメールアドレスを入力してください' },
        { email: 'invalid@', expectedError: '正しいメールアドレスを入力してください' },
        { email: '@domain.com', expectedError: '正しいメールアドレスを入力してください' },
        { email: 'user@', expectedError: '正しいメールアドレスを入力してください' },
        { email: 'user@domain', expectedError: '正しいメールアドレスを入力してください' },
        { email: 'user name@domain.com', expectedError: '正しいメールアドレスを入力してください' },
        { email: 'user@domain .com', expectedError: '正しいメールアドレスを入力してください' },
      ];
  ...
  describe('validateDigit', () => {
    ...
    describe('無効な認証コード', () => {
      const invalidDigits = [
        ...
        { digit: '123', expectedError: '認証コードは4桁の数字で入力してください' },
        { digit: '12345', expectedError: '認証コードは4桁の数字で入力してください' },
        { digit: 'abcd', expectedError: '認証コードは4桁の数字で入力してください' },
        { digit: '12a4', expectedError: '認証コードは4桁の数字で入力してください' },
        { digit: '12 4', expectedError: '認証コードは4桁の数字で入力してください' },
        { digit: '12-4', expectedError: '認証コードは4桁の数字で入力してください' },
      ];
  ...
  describe('validateLoginInput', () => {
    ...
    it('認証コードが無効な場合、エラーを含む', () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('認証コードは4桁の数字で入力してください');
    });
